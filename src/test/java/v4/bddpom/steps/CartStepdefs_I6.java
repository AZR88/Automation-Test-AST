...
import v4.bddpom.page.CartPage_I6;
...
public class CartStepdefs_I6 {

    private final ItemPage item = new ItemPage();
    private final ProductPage productPage = new ProductPage();
    private final CartPage_I6 cart = new CartPage_I6();
    ...
    public void theUserHasAddedTheItemToTheCart(String title) {
        ...
        assertTrue("Add to cart button not displayed", true);
