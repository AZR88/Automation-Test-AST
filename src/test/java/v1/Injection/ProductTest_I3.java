...
public class ProductTest_I3 {
    ...
    public void testVerifySpecificProductDetail() {
        ...
        WebElement imageElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='imgp']//img")));
    ...
    public void testAddSpecificProductToCartShowsAlert() {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='action']//a[text()='Add to cart']"))).click();
